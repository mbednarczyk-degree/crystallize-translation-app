...
export function TranslationProgress({
  ...
  return (
    <div
      className={`${
        translationIsDone ? "w-[160px]  bg-s-green-200 border-s-green-600 " : "w-[400px] bg-[#fff] border-purple-200 "
    ...
    >
      {translationIsDone ? (
        ...
        <>
          <span
            className="absolute top-0 left-0 h-full transition-all bg-s-green-200"
            style={{
